...
void AiClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (AiClient::*)(const QString & )>(_a, &AiClient::responseReceived, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (AiClient::*)(const QString & )>(_a, &AiClient::errorOccurred, 1))
            return;
    }
}
...
// SIGNAL 0
void AiClient::responseReceived(const QString & _t1)
{
